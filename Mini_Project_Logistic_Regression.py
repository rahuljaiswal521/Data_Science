...
dflog=pd.read_csv(r"F:\Data_Science\2015lab5-master\data\01_heights_weights_genders.csv")
dflog.head()
...
for C in Cs:
    ...
    clf1.fit(Xlr, ylr)
# Print the accuracy from the testing data.
    acc =(accuracy_score(clf1.predict(Xtestlr), ytestlr))
    print("Accuracy Scrore when C is", C, ": ",acc)    
